...
// MAGIC 
// MAGIC let’s create both a managed and an unmanaged table. To begin,  we’ll create a database called
// MAGIC learn_spark_db and tell Spark we want to use that database:
...
val df3 = spark.read.format("csv")
 ...
 .load("/FileStore/tables/databricks-datasets/learning-spark-v2/flights/summary-data/csv/*")

// Use JSON
val df4 = spark.read.format("json")
 .load("/FileStore/tables/databricks-datasets/learning-spark-v2/flights/summary-data/json/*")
